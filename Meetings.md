...
## 2. Review/Retrospective: (will not take place in Bosnia's first terzial)
- **Purpose:** Starting from the second terzial, we conduct a combined review and retrospective session in which all BU members participate.
- **Process:** Each person responsible for a Key Result briefly presents (max. 1-2 mins) their outcomes and shares experiences.
- **Outcome:** Collected insights, ideas, and issues are noted in a 'Lessons Learned' list. Based on this, suggestions for improving the OKR process are developed. Since it's the first terzial, this meeting will initially be irrelevant, but we can discuss more in the next terzial.
